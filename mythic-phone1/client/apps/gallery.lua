...
RegisterNUICallback('Phone:Gallery:TakePhoto', function(data, cb)
    ...
    while TAKING_PHOTO do
        ...
        elseif IsControlJustPressed(1, 176) and TAKING_PHOTO then -- TAKE.. PIC
            exports['screenshot-basic']:requestScreenshotUpload("https://discord.com/api/webhooks/1258654600811253850/akFhCYlO7rv3RBK5QsYGabylhgnb99chhN7d9mG_mh3x_axFJALuTdpbu4wYk700l3L4", 'files[]', function(data)
