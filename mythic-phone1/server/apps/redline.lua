...
local _awardedAmount = 10
local _cryptoPayout = 16

local _reqForCrypto = 1

local _races = {}
local _tracks = nil

local _raceItems = {
	{ item = "racingtablet", coin = "PLEB", price = 20, qty = 100, vpn = true },
	-- { item = "racedongle", coin = "VRM", rep = "Racing", repLvl = 3, price = 50, qty = 5, vpn = false },
	-- { item = "harness", coin = "VRM", rep = "Racing", repLvl = 1, price = 100, qty = 5, vpn = false },

	-- { item = "lsundg_invite", coin = "PLEB", rep = "Salvaging", repLvl = 5, price = 200, qty = -1, vpn = true },
...
-- 	{ item = "fakeplates", coin = "PLEB", price = 48, qty = 2, vpn = true },
	...
	-- { item = "nitrous", coin = "VRM", price = 10, qty = 200, vpn = true },
...
AddEventHandler("Phone:Server:RegisterMiddleware", function()
	Vendor:Create("RaceGear", "poly", "Race Gear", false, {
		coords = vector3(218.39, 139.99, 103.41),
		length = 1.0,
		width = 1.0,
		options = {
			heading = 340,
